		...
		<div className="max-w-2xl mx-auto px-4 w-full">
			...
			<div className="space-y-4">
				...
				{mockDocuments.map((doc) => {
					...
					const totalCards = doc.chapters.reduce(
						(sum, ch) => sum + ch.totalCards,
						0,
					);
					const completedCards = doc.chapters.reduce(
						(sum, ch) => sum + ch.completedCards,
						0,
					);
												...
												>
													<div className="flex-1">
														...
														<p className="text-xs text-muted-foreground">
															{chapter.completedCards} / {chapter.totalCards}{" "}
															cards
														</p>
													</div>
